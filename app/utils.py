...
def load_index(filename:str = 'image_check', hash_size: int = 16) -> IndexBinaryFlat:
    d = hash_size**2
    try:
...
def save_index(index: IndexBinaryFlat, filename:str = 'image_check', hash_size: int = 16) -> None:
    d = hash_size**2
